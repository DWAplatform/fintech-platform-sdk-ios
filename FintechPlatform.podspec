#
#  Be sure to run `pod spec lint FintechPlatform.podspec' to ensure this is a
...
Transactions list
  ...
  s.author             = "Fintech Platform"
  # Or just: s.author    = "ingrid"
  # s.authors            = { "ingrid" => "fermingrid@gmail.com" }
  # s.social_media_url   = "http://twitter.com/ingrid"
